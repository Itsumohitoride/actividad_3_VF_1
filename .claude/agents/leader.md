...
2. Need research? -> 2-3 `explorer` in parallel, bounded questions.
...
Good example prompt:
> "Investigate persistence module in `src/storage.py`. Write findings in `progress/research_storage.md`. Reply: `done -> progress/research_storage.md` or block message."
